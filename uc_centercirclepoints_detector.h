...
class UpperCamCenterCirclePointDetector : BaseDetector {
public:
    UpperCamCenterCirclePointDetector(int8_t* lutCb, int8_t* lutCr, HtwkVisionConfig& config);

    UpperCamCenterCirclePointDetector(const UpperCamCenterCirclePointDetector&) = delete;
    UpperCamCenterCirclePointDetector(const UpperCamCenterCirclePointDetector&&) = delete;
    UpperCamCenterCirclePointDetector& operator=(const UpperCamCenterCirclePointDetector&) = delete;
    UpperCamCenterCirclePointDetector& operator=(UpperCamCenterCirclePointDetector&&) = delete;
    ~UpperCamCenterCirclePointDetector();
