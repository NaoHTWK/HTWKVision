...
class UpperCamGoalPostDetector : BaseDetector {
public:
    UpperCamGoalPostDetector(int8_t* lutCb, int8_t* lutCr, HtwkVisionConfig& config);

    UpperCamGoalPostDetector(const UpperCamGoalPostDetector&) = delete;
    UpperCamGoalPostDetector(const UpperCamGoalPostDetector&&) = delete;
    UpperCamGoalPostDetector& operator=(const UpperCamGoalPostDetector&) = delete;
    UpperCamGoalPostDetector& operator=(UpperCamGoalPostDetector&&) = delete;
    ~UpperCamGoalPostDetector();
